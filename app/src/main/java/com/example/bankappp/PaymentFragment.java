...
public class PaymentFragment extends Fragment {
    ...
    private TextView Coundwontimer;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Coundwontimer =rootView.findViewById(R.id.Coundowntimer);
        setValues();
        //////////////BAck to DashBoard
            ...
            public void handleOnBackPressed() {
                ...
                new CountDownTimer(5000, 1000) {
                    ...
                    public void onTick(long millisUntilFinished) {
                        Coundwontimer.setVisibility(VISIBLE);
                        Coundwontimer.setText("Please Wait It will Be Redirected To Home Page : " + millisUntilFinished / 1000);
